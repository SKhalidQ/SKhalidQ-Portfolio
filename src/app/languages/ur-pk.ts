...
export const urPK: LanguageStrings = {
  aboutPage: {
    ...
    checkUpdates: 'اپ ڈیٹس چیک کریں', // App updates check karen
    checkUpdatesDialog: {
      action : {
        cancel: 'منسوخ کریں', // Mansookh karen
        close: 'بند کریں', // Band karen
        update: 'اپ ڈیٹ کریں' // Update karen
      },
      disabledUpdate: {
        message: 'خودکار اپ ڈیٹس اس ماحول میں فعال نہیں ہیں۔', // Khudkar updates is mahol mein fa'al nahi hain.
        title: 'اپ ڈیٹ غیر فعال ہیں' // Update ghair fa'al hain
      },
      lostConnection: {
        message: 'لگتا ہے کہ آپ کا کنکشن منقطع ہو گیا ہے۔ ہو سکتا ہے کہ کچھ فیچرز کام نہ کریں۔', // Lagta hai ke aap ka connection munqati ho gaya hai. Ho sakta hai ke kuch features kaam na karen.
        title: 'کنکشن کھو گیا' // Connection kho gaya
      },
      newUpdate: {
        message: 'اس صفحہ پر نیا مواد دستیاب ہے۔ کیا آپ اپ ڈیٹ کرنا چاہیں گے؟', // Is safha par naya mawad dastiyab hai. Kya aap update karna chaheinge?
      ...
      noNewUpdate: {
        ...
        title: 'کوئی نئی اپ ڈیٹ دستیاب نہیں ہے' // Koi nayi update dastiyab nahi hai
      },
      updateError: {
        message: 'اس وقت اپ ڈیٹس چیک کرنے میں ناکامی ہوئی ہے۔ براہ کرم بعد میں دوبارہ کوشش کریں۔', // Is waqt updates check karne mein nakaami hui hai. Barah-e-karam baad mein dobara koshish karen.
        title: 'اپ ڈیٹ چیک کرنے میں ناکامی' // Update check karne mein nakaami
      }
    }
  },
  curriculumPage: {
    ...
    copyToClipboard: 'کاپی کریں', // Copy karen
    educationHistory: {
      institutions: {
        academy: {
    ...
    technicalSkills: {
      sections: {
        ...
        cloudAndInfrastructure: {
          ...
          title: 'کلاؤڈ اور انفراسٹرکچر' // Cloud aur Infrastructure
        },
        devOpsAndTooling: {
          skills: {
  ...
  errorPage: {
    ...
    genericError: 'ہمارے طرف سے کچھ غلط ہو گیا۔ براہ کرم بعد میں دوبارہ کوشش کریں۔' // Hamare taraf se kuch ghalat ho gaya. Barah-e-karam baad mein dobara koshish karen.
  },
  homePage: {
    cvHighlight: {
      description: 'میرے سی وی میں میرا پیشہ ورانہ سفر، مہارتیں، تجربات اور دلچسپیاں دریافت کریں۔', // Mere CV mein mera pesha warana safar, mahartain, tajurbaat aur dilchaspiyan daryaft karen.
      navigationButton: {
        text: 'سی وی دیکھیں' // CV dekhen
      }
    },
    projectsHighlight: {
      description: 'میرے پروجیکٹس اور وہ ٹیکنالوجیز دیکھیں جو میں نے استعمال کی ہیں۔', // Mere projects aur woh technologies dekhen jo main ne istemal ki hain.
      navigationButton: {
        text: 'پروجیکٹس دیکھیں' // Projects dekhen
      }
    },
  ...
  navigationButtons: {
    about: 'کے بارے میں', // Ke baray mein
  ...
  projectsPage: {
    ...
    ProjectTypeFilter: {
      ...
      WorkProject: 'کام کے پروجیکٹس' // Work Projects
    },
    visitSite: 'ویب سائٹ پر جائیں' // Website par jayein
  },
  themeMenu: {
    options: {
  ...
  snackbar: {
    connectionRestored: 'کنکشن بحال ہو گیا ہے', // Connection bahaal ho gaya hai
    copiedToClipboard: 'کاپی کیا گیا ہے', // Copy kiya gaya hai
    dismiss: 'ختم کریں', // Khatam karen
    languageChanged: 'زبان تبدیل کر دی گئی ہے {0}', // Zaban tabdeel kar di gayi hai {0}
