...
export const SocialMediaButtons: NavigationButton[] = [
  ...
  { text: 'LinkedIn', icon: '../assets/images/logos/linkedin-logo.svg', route: 'https://www.linkedin.com' },
  { text: 'GitHub', icon: '../assets/images/icons/github-brands-light.svg', route: 'https://www.github.com' }
];
