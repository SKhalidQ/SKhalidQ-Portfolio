...
import { EducationEng, EmploymentEng, Hobbies, TechnicalSkills, CVTItlesEng, LanguagesEng, NonTechSkills, Achievements } from 'src/app/Models/curriculum-Models';
