...
export const Projects: ProjectData[] = [
  ...
  },
  {
    ...
    description: 'ASP.NET Core Web API project with endpoints for various cryptographic functions using symmetric and asymmetric encryption. ' +
    'Uses claims-based authorization and Entity Framework Core.',
    website: false,
    websiteURL: '',
    publicRepo: false,
    githubURL: '',
  ...
  },
  {
    ...
    description: 'A simple chatbot built using SWI Prolog which responds with a recommendation depending on the input.',
    website: false,
    websiteURL: '',
    publicRepo: false,
    githubURL: '',
